...
def csv_to_zarr(filename, freq_to_hertz, dish_diam):
    ...
    coords = {
        "pol": pol_codes,
        "chan": chan_freq * freq_to_hertz,
        "coef_indx": np.arange(num_coef),
    }
...
if __name__ == "__main__":
    ...
    filenames = [
        "data/EVLA_avg_zcoeffs_LBand_lookup.csv",
        "data/EVLA_avg_zcoeffs_SBand_lookup.csv",
        "data/MeerKAT_avg_zcoeffs_LBand_lookup.csv",
        "data/EVLA_avg_zcoeffs_SBand_lookup_holoeta.csv",
        "data/EVLA_avg_zcoeffs_SBand_lookup_noeta.csv",
        "data/EVLA_avg_zcoeffs_SBand_lookup_stdeta.csv",
    ]
